    ...
    try {
      ...
      emit(
        state.copyWith(
          ...
          skip: state.skip + event.limit,
          hasMaxReached: products.length >= productData.total,
        ),
      );
    } catch (e) {
      emit(
    ...
    try {
      ...
      emit(
        state.copyWith(
          ...
          totalCount: productData.total,
          skip: event.limit,
          hasMaxReached: productData.products.length >= productData.total,
        ),
      );
    } catch (e) {
      emit(
